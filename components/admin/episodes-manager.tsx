...
export const EpisodesManager = ({
  ...
  // Count how many questions are filled (have questionText)
  const getFilledCount = (episode: EpisodeWithQuestionCount) => {
    // For now we just show total questions - we'll need to track filled separately
    return episode._count.questions;
  };
